...
export default function AIAssistButton() {
  ...
  const sendMessage = async (text: string) => {
    ...
    // TODO: Replace with actual Groq API call via backend
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "I'm the SkillBridge AI assistant! To enable me, connect the Groq API. I can help you extract skills from text, suggest offerings, rewrite requests, and more. 🚀",
        },
      ]);
      setLoading(false);
    }, 1000);
